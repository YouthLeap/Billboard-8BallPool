...
public class GameManager
{
    ...
    public bool Ball8ForSolid = false;
    public bool Ball8ForStriped = false;
    public bool firstBallPot = false;
    ...
    public static string playerTotalUpdatedAmt;
    public string nameMy;
    public string loginKeyValue;
    public static string playerToken = string.Empty;
    public static string amountUpdate;
    ...
    public int payoutCoins = 1000;
    public int payoutCoinsWithoutComission = 1000;

    public bool otherPlayerJoined = false;
    public bool Player_AI = false;
    public string opponentName_AI = "";
    
    public Vector3 rayOrigin_AI;
    public Vector3 rayDirection_AI;
