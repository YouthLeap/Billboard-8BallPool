...
public class BuyItemControl : MonoBehaviour {
    ...
    void Start() {
        ...
        //    if (this.index == 1) {
        //        //priceText.GetComponent<Text>().text = GameManager.Instance.IAPControl.controller.products.WithID(GameManager.Instance.IAPControl.SKU_Free_COINS).metadata.localizedPriceString;
